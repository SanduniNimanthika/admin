      ...
      child: new Scaffold(
          ...
          body: ListView(children: <Widget>[
            Padding(
              ...
              child: TextField(style: Theme.of(context).textTheme.display1,
                onChanged: (val) {
                  initiateSearch(val);
                },
            ...
            ListView(
                ...
                children: tempSearchStore.map((element) {
                  return InkWell(
                      onTap: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context)=>Editproduct(text:element['catergory'],text2:element['subcatergory'],catkey: element['catergorykey'],subcatkey: element['uid'],)));
                      },
                      child:Padding(
